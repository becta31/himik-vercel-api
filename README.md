...
Архитектура проекта (ARCHITECTURE.md) — как устроена система.
API Документация (API_DOCS.md) — как работать с бэкендом.
Руководство для участников (CONTRIBUTING.md) — как помочь проекту.
